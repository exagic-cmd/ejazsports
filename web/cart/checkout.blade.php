                                ...
                                <div class="bg-gray-1 rounded-lg">
                                    ...
                                    <div class="p-4 mb-4 checkout-table">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr class="cart_item">
                                                    <td>Hard Ball Bat&nbsp;<strong class="product-quantity">× 1</strong></td>
                                                    <td>Rs. 1,100.00</td>
                                                </tr>
                                                <tr class="cart_item">
                                                    <td>CARDBOARD LUDO 19INCHES &nbsp;<strong class="product-quantity">× 1</strong></td>
                                                    <td>Rs. 685.00</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <th>Shipping</th>
                                                    <td>Flat rate Rs. 300.00</td>
                                                </tr>
                                                <tr>
                                                    <th>Total</th>
                                                    <td><strong>Rs. 2,085.00</strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        <!-- End Product Content -->
                                        ...
                                        <a href="{{route('account.thankyou')}}" class="btn btn-primary-dark-w btn-block btn-pill font-size-20 mb-3 py-3">Place order</a>
                                    </div>
                                    <!-- End Order Summary -->
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="firstName" placeholder="Jabir" aria-label="Jabir" required="" data-msg="Please enter your frist name." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="lastName" placeholder="Ameen" aria-label="Ameen" required="" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="streetAddress" placeholder="F10/4 Street 89" aria-label="F10/4 Street 89" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Naeem Heights" aria-label="Naeem Height" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="email" class="form-control" name="emailAddress" placeholder="jabirameen@gmail.com" aria-label="jabirameen@gmail.com" required="" data-msg="Please enter a valid email address." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="+923226767876" aria-label="03226767876" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
