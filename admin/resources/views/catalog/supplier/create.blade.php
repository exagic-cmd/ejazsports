    ...
    <div class="row">
        <div class="col-9">
            <div class="content-header">
                <h2 class="content-title">Add New Supplier</h2>
                <div>
                ...
                <div class="card-body">
                    <form action="{{route('suppliers.store')}}" method="post" id="form">
                        ...
                        <div class="mb-4 position-relative">
                            ...
                            <input type="text" name="name" placeholder="Type here" class="form-control @error('name') is-invalid @enderror" id="product_name" value="{{ old('name') }}" autocomplete="off">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="ntn_number" placeholder="Type here" class="form-control @error('ntn_number') is-invalid @enderror" id="product_name" value="{{ old('ntn_number') }}">
                            @error('ntn_number')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="office_number" placeholder="Type here" class="form-control @error('office_number') is-invalid @enderror" value="{{ old('office_number') }}">
                            @error('office_number')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="email" placeholder="Type here" class="form-control @error('email') is-invalid @enderror" id="product_name" value="{{ old('email') }}">
                            @error('email')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    success: function(data) {
                        ...
                        if (data && data.length > 0) {
                            let html = `<div class="name-suggestions-header">
                                ⚠️ ${data.length} similar existing vendor/supplier(s) found! Check below to avoid duplicate.
                            </div>`;
