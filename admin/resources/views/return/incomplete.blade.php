...
@section('content')
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">All Incomplete Returns</h2>
                    ...
                    @foreach($receiving as $r)
                        ...
                        <tr >
                            ...
                            <td class="text-end">
                                    ...
                                    <a href="{{route('supplier-returns.edit',$r->id)}}" class="btn btn-md rounded font-sm">Detail</a>

                                @if($r->status == \App\Models\Receiving::APPROVAL_PENDING)

                                <a href="{{route('supplier-returns.edit',$r->id)}}" class="btn btn-md rounded font-sm">Update</a>
