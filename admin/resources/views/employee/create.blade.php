    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                @endif
                <div class="card-body">
                    <form action="{{route('employees.store')}}" method="post" id="form">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="mobile_number" placeholder="Type here" class="form-control @error('mobile_number') is-invalid @enderror"  value="{{ old('mobile_number') }}">
                            @error('mobile_number')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="com_per_retail" placeholder="Type here" class="form-control @error('com_per_retail') is-invalid @enderror"  value="{{ old('com_per_retail') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="com_per_whole" placeholder="Type here" class="form-control @error('com_per_whole') is-invalid @enderror"  value="{{ old('com_per_whole') }}">
                            @error('com_per_whole')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
