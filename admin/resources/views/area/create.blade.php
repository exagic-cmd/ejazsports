    ...
    <div class="row">
        <div class="col-9">
            <div class="content-header">
                <h2 class="content-title">Add New Area</h2>
                <div>
        ...
        <div class="col-lg-6">
            <form action="{{route('areas.store')}}" method="post" id="form" autocomplete="false" >
                @csrf
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="delivery_charges" placeholder="Type here" class="form-control @error('delivery_charges') is-invalid @enderror" value="{{ old('delivery_charges') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="min_order_amount" placeholder="Type here" class="form-control @error('min_order_amount') is-invalid @enderror" value="{{ old('min_order_amount') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="delivery_charges_above" placeholder="Type here" class="form-control @error('delivery_charges_above') is-invalid @enderror" value="{{ old('delivery_charges_above') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="min_weight_allow" placeholder="Type here" class="form-control @error('min_weight_allow') is-invalid @enderror" value="{{ old('min_weight_allow') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="extra_charges_per_g_ml" placeholder="Type here" class="form-control @error('extra_charges_per_g_ml') is-invalid @enderror" value="{{ old('extra_charges_per_g_ml') }}">
