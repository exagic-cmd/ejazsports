...
@section('content')
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">All Scanned Orders</h2>
            <p>Order Information {{number_format($orders->sum('total_amount'))}} - ({{count($orders)}})</p>
        </div>
        @can('Scan Orders')
            <div>
                <a href="{{route('orders.scan.new')}}" class="btn btn-primary"><i class="text-muted material-icons md-post_add"></i>Add New Scan</a>
            </div>
            @endcan
