    ...
    <div class="row">
        <div class="col-12">
            <div class="content-header">
                <h2 class="content-title">New Customer Payment</h2>
                <div>
        ...
        <form action="{{route('customer-payments.store')}}" method="post" id="form" enctype="multipart/form-data" autocomplete="false" style="display: contents">
            @csrf
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="col-lg-6" >
                        ...
                        <div @class('row')>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Received Amount</label>
