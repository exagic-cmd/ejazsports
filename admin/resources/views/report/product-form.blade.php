...
@section('content')
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Products Reports</h2>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-body mb-4">
                <form method="post" action="{{route('report.product')}}">
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <label class="col-lg-3 col-form-label">Product<span style="color: red;"> *</span></label>
                        <div class="col-lg-9">
