    ...
    <div class="row">
        <div class="col-9">
            <div class="content-header">
                <h2 class="content-title">Add New Courier</h2>
                <div>
        ...
        <div class="col-lg-6">
            <form action="{{route('couriers.store')}}" method="post" id="form" autocomplete="false" >
                @csrf
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="text" name="representative_name" placeholder="Type here" class="form-control @error('representative_name') is-invalid @enderror" value="{{ old('representative_name') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="rate" placeholder="Type here" class="form-control @error('rate') is-invalid @enderror" value="{{ old('rate') }}">
                        @error('rate')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="allow_weight_gm_ml" placeholder="Type here" class="form-control @error('allow_weight_gm_ml') is-invalid @enderror" value="{{ old('allow_weight_gm_ml') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="number" name="extra_charges_above_weight" placeholder="Type here" class="form-control @error('extra_charges_above_weight') is-invalid @enderror" value="{{ old('extra_charges_above_weight') }}">
