            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{route('permissions.store')}}" method="post" id="form">
                        ...
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Guard  Name</label>
                            <input  type="text" name="system_name" placeholder="Type here" class="form-control @error('system_name') is-invalid @enderror"  value="{{ old('system_name') }}">
                            @error('system_name')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="module" placeholder="Type here" class="form-control @error('module') is-invalid @enderror" value="{{ old('module') }}">
                            @error('module')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input  type="text" name="sub_module" placeholder="Type here" class="form-control @error('sub_module') is-invalid @enderror"  value="{{ old('sub_module') }}">
                            @error('sub_module')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
