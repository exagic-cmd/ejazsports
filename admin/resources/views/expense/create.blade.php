...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form action="{{route('expense.store')}}" method="post" id="form" autocomplete="false" enctype="multipart/form-data">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="bill_no" placeholder="Type here" class="form-control @error('bill_no') is-invalid @enderror" value="{{ old('bill_no') }}">
                            @error('bill_no')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    <div class="mb-4">
                        ...
                        <input  type="date" name="date" placeholder="Type here" class="form-control @error('date') is-invalid @enderror" value="{{ old('date') }}">
                        @error('date')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                        <div class="mb-4">
                            ...
                            <input  type="text" name="amount" placeholder="Type here" class="form-control @error('amount') is-invalid @enderror" value="{{ old('amount') }}">
                            @error('amount')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    <div class="mb-4">
                        ...
                        <textarea name="detail" placeholder="Type here" class="form-control @error('detail') is-invalid @enderror">{{old('detail')}}</textarea>
                        @error('detail')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
