...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form action="{{route('banners.store')}}" method="post" id="form" autocomplete="false" enctype="multipart/form-data">
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="web_heading" placeholder="Type here" class="form-control @error('web_heading') is-invalid @enderror" value="{{ old('web_heading') }}">
                            @error('web_heading')
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="text" name="web_sub_heading" placeholder="Type here" class="form-control @error('web_sub_heading') is-invalid @enderror" value="{{ old('web_sub_heading') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="text" name="mobile_heading" placeholder="Type here" class="form-control @error('mobile_heading') is-invalid @enderror" value="{{ old('mobile_heading') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="text" name="mobile_sub_heading" placeholder="Type here" class="form-control @error('mobile_sub_heading') is-invalid @enderror" value="{{ old('mobile_sub_heading') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input  type="text" name="url" placeholder="Type here" class="form-control @error('url') is-invalid @enderror" value="{{ old('url') }}">
                        @error('url')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="col-lg-3">
            <div class="card mb-4">
                <div class="card-header">
                    <h4>Web Banner <span style="color: red;">*</span></h4>
                </div>
                <div class="card-body">
