...
@section('content')
    ...
    <div class="row">
        ...
        <form style="display: contents" action="{{route('promotion.store')}}" method="post" id="form" autocomplete="false" enctype="multipart/form-data">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="numeric" name="web_count" placeholder="Type here" class="form-control @error('web_count') is-invalid @enderror" value="{{ old('web_count') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input  type="text" name="mobile_count" placeholder="Type here" class="form-control @error('mobile_count') is-invalid @enderror" value="{{ old('mobile_count') }}">
                            @error('mobile_count')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="input_fields_wrap">
                        ...
                        <div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="url[]" class="form-control " placeholder="Type here">
                                    @error('url')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9">
                                    <input type="numeric" value="0" name="serial_no_i[]" class="form-control " placeholder="Type here">
