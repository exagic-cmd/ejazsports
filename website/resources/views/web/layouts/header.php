...
<html lang="en">
   <head>
        ...
        <link rel="stylesheet" href="./assets/css/theme.css?v1.0.0.2">
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to EjazSports Online Store</a>
                            </div>
                            <div class="topbar-right ml-auto">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        <a href="#" class="u-header-topbar__nav-link"><i class="ec ec-map-pointer mr-1"></i> My Account</a>
                                    </li>
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                    <!-- Logo -->
                                    <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="#" aria-label="EjazSports">
                                        ...
                                        <div class="u-sidebar__container">
                                            <div class="u-header-sidebar__footer-offset">
                                                ...
                                                <div class="js-scrollbar u-sidebar__body">
                                                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                        <!-- Logo -->
                                                        <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center mb-3" href="#">
                                                             <img class="img-fluid" src="./assets/img/logo.png">
                                                        </a>
                                                        <!-- End Logo -->
                                            ...
                                            <footer id="SVGwaveWithDots" class="svg-preloader u-header-sidebar__footer">
                                                ...
                                                <div class="position-absolute right-0 bottom-0 left-0 z-index-n1">
                                                    <img class="js-svg-injector" src="./assets/img/wave-bottom-with-dots.svg" alt="EjazSports"
                            ...
                            <div class="col d-none d-xl-block">
                                <form class="js-focus-state" method="GET" action="{{ route('search') }}">
                                    ...
                                    <div class="input-group">
                                        <input type="search" class="form-control py-2 pl-5 font-size-15 border-right-0 height-40 border-width-2 rounded-left-pill border-primary" name="q" id="searchproduct-item" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" value="{{ request()->get('q') }}">
                                            ...
                                            <select name="category" class="js-select selectpicker dropdown-select custom-search-categories-select"
                                                ...
                                                @if(isset($grouped) && $grouped)
                                                    @foreach($grouped as $parentId => $cats)
                                                        @foreach($cats as $cat)
                                                            <option value="{{ $cat->category_id }}" {{ request()->get('category') == $cat->category_id ? 'selected' : '' }}>{{ $cat->category_title }}</option>
                                                        @endforeach
                                                    @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col d-xl-none px-2 px-sm-3 position-static">
                                            ...
                                            <div id="searchClassic" class="dropdown-menu dropdown-unfold dropdown-menu-right left-0 mx-2" aria-labelledby="searchClassicInvoker">
                                                <form class="js-focus-state input-group px-3" method="GET" action="{{ route('search') }}">
                                                    <input class="form-control" type="search" name="q" value="{{ request()->get('q') }}" placeholder="Search Product">
                                                    <select class="form-control ml-2" name="category" aria-label="Category">
                                                        <option value="">All Categories</option>
                                                        @if(isset($grouped) && $grouped)
                                                            @foreach($grouped as $parentId => $cats)
                                                                @foreach($cats as $cat)
                                        ...
                                        <li class="col d-none d-xl-block">
                                            <a href="#" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Compare"><i class="font-size-22 ec ec-compare"></i></a>
                                        </li>
                                        <li class="col d-none d-xl-block">
                                            <a href="#" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="font-size-22 ec ec-favorites"></i></a>
                                        </li>
                                        <li class="col d-xl-none px-2 px-sm-3">
                                            <a href="#" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="My Account"><i class="font-size-22 ec ec-user"></i></a></li>
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3 d-none d-xl-block">
                                            ...
                                            <div id="basicDropdownHover" class="cart-dropdown dropdown-menu dropdown-unfold border-top border-top-primary mt-3 border-width-2 border-left-0 border-right-0 border-bottom-0 left-auto right-0" aria-labelledby="basicDropdownHoverInvoker">
                                                        ...
                                                        <div class="">
                                                            <ul class="list-unstyled row mx-n2">
                                                                <li class="px-2 col-auto">
                                                                    <img class="img-fluid" src="./assets/img/logo.png" alt="Ejaz Sports" style="height: 50px;">
                                                                </li>
                                                                <li class="px-2 col">
                                                                    <h5 class="text-blue font-size-14 font-weight-bold">Hard ball bat</h5>
                                                    ...
                                                    <li class="border-bottom pb-3 mb-3">
                                                        <div class="">
                                                            <ul class="list-unstyled row mx-n2">
                                                                ...
                                                                <li class="px-2 col">
                                                                    <h5 class="text-blue font-size-14 font-weight-bold">IHSAN 6 BAT</h5>
                                                ...
                                                <div class="flex-center-between px-4 pt-2">
                                                    <a href="#" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5">View cart</a>
