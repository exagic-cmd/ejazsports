                ...
                <div id="shopCartAccordion" class="accordion rounded mb-5">
                    ...
                    <div class="card border-0">
                        ...
                        <div id="shopCartOne" class="collapse border border-top-0" aria-labelledby="shopCartHeadingOne" data-parent="#shopCartAccordion" style="">
                            <!-- Form -->
                            <form class="js-validate p-3 p-md-5">
                                <!-- Title -->
                                <div class="mb-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="apt_suite" placeholder="Naeem Heights" aria-label="Naeem Height" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="phone" placeholder="+923226767876" aria-label="03226767876" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
