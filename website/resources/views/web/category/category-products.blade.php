                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 col-wd-9gdot5">
                        ...
                        <div class="flex-center-between mb-3">
                            <h3 class="font-size-25 mb-0">{{$category->title}}</h3>
                                        ...
                                        <div class="product-item__outer h-100 w-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2"><a href="{{ route('product.detail', $p->id) }}" class="font-size-12 text-gray-5">{{$category->title}}</a></div>
                                                    <h5 class="mb-1 product-item__title"><a href="{{ route('product.detail', $p->id) }}" class="text-blue font-weight-bold">{{$p->title}}</a></h5>
                                                    <div class="mb-2">
                                                        <a href="{{ route('product.detail', $p->id) }}" class="d-block text-center">
                                                        	<img class="img-fluid" src="{{env('BACKEND_IMAGE_URL').($p->thumbnail ? $p->thumbnail->url : '')}}" alt="Image Description" style="height: 250px;width: 100%;"></a>
                                                    </div>
                                                    <div class="flex-center-between mb-1">
                                                        <div class="prodcut-price">
                                                            <div class="text-gray-100">Rs. {{$p->price}}</div>
                                                        </div>
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <h5 class="mb-1 product-item__title"><a href="{{ route('product.detail', $p->id) }}" class="text-blue font-weight-bold">{{$p->title}}</a></h5>
                                                    <div class="mb-2">
                                                        <a href="{{ route('product.detail', $p->id) }}" class="d-block text-center"><img class="img-fluid" src="{{env('BACKEND_IMAGE_URL').($p->thumbnail ? $p->thumbnail->url : '')}}" alt="{{$p->title}}" style="height: 250px;width: 100%;"></a>
                                                    </div>
                                                    <div class="mb-3">
                                        ...
                                        <div class="product-item__outer w-100">
                                            <div class="product-item__inner remove-prodcut-hover py-4 row">
                                                <div class="product-item__header col-6 col-md-4">
                                                    <div class="mb-2">
                                                        <a href="{{ route('product.detail', $p->id) }}" class="d-block text-center"><img class="img-fluid" src="{{env('BACKEND_IMAGE_URL').($p->thumbnail ? $p->thumbnail->url : '')}}" alt="{{$p->title}}" style="width: 100%;height: 250px;"></a>
                                                    </div>
                                                </div>
                                                <div class="product-item__body col-6 col-md-5">
                                                    <div class="pr-lg-10">
                                                        <div class="mb-2"><a href="#" class="font-size-12 text-gray-5">{{$category->title}}</a></div>
                                                        <h5 class="mb-2 product-item__title"><a href="{{ route('product.detail', $p->id) }}" class="text-blue font-weight-bold">{{$p->title}}</a></h5>
                                                ...
                                                <div class="product-item__footer col-md-3 d-md-block">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="prodcut-add-cart">
                                                            <a href="{{route('cart')}}" class="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">Add to cart</a>
                                                        </div>
                                                    </div>
