                                                    ...
                                                    <div class="product-item__outer h-100">
                                                        <div class="product-item__inner p-md-3 row no-gutters">
                                                            <div class="col col-lg-auto product-media-left">
                                                                <a href="{{ route('productdetail', $bS->slug ?: \Illuminate\Support\Str::slug($bS->title)) }}" class="max-width-150 d-block">
                                                            ...
                                                            <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                                <div class="mb-4">
                                                                    <div class="mb-2"><a href="{{ route('productdetail', $bS->slug ?: \Illuminate\Support\Str::slug($bS->title)) }}" class="font-size-12 text-gray-5">{{ $bS->brand_title }}</a></div>
                                                                    <h5 class="product-item__title"><a href="{{ route('productdetail', $bS->slug ?: \Illuminate\Support\Str::slug($bS->title)) }}" class="text-blue font-weight-bold">{{ $bS->title }}</a></h5>
                                                                </div>
                                            ...
                                            <div class="product-item">
                                                <div class="product-item__outer h-100">
                                                    <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                                        <div class="product-item__body pb-xl-2">
                                                            <div class="mb-2"><a href="#" class="font-size-12 text-gray-5">{{ $rV->brand_title }}</a></div>
                                                            <h5 class="mb-1 product-item__title"><a href="{{ route('productdetail', $rV->slug ?: \Illuminate\Support\Str::slug($rV->title)) }}" class="text-blue font-weight-bold">{{ $rV->title }}</a></h5>
                                                            <div class="mb-2">
                                                                <a href="{{ route('productdetail', $rV->slug ?: \Illuminate\Support\Str::slug($rV->title)) }}" class="d-block text-center">
