		...
		initSlickCarousel: function () {
			...
			this.collection.each(function (i, el) {
				...
				var $this = $(el),
					...
					thumbProgressOptions = el.getAttribute('data-thumbs-progress-options') ? JSON.parse(el.getAttribute('data-thumbs-progress-options')) : {},
					...
					setResponsive = el.getAttribute('data-responsive') ? JSON.parse(el.getAttribute('data-responsive')) : [];
				...
				if (isThumb) {
					...
					$('#' + id).on('click', '.slick-slide', function (e) {
						...
						if ($('#' + id).hasClass('slick-initialized') && $('#' + id).slick('slickCurrentSlide') !== i) {
